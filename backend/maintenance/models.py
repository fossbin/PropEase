...
class MaintenanceTickets(models.Model):
    ...
    raised_by = models.ForeignKey('users.Users', models.DO_NOTHING, db_column='raised_by', blank=True, null=True)
    assigned_to = models.ForeignKey('users.Users', models.DO_NOTHING, db_column='assigned_to', related_name='maintenancetickets_assigned_to_set', blank=True, null=True)
